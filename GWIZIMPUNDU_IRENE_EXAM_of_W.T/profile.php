...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <input type="text" id="" name="passengerid" required><br><br>

    <label for="weight">Weight:</label>
    <input type="text" id="passengeid" name="passengeid" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO profile(profile_id,UserId, age,height,weight) VALUES (?, ?, ?,?,?)");
    $stmt->bind_param("issss", $profile_id, $UserId,$age,$height,$weight);
    // Set parameters and execute
    $profile_id = $_POST['book_id'];
    $UserId = $_POST['ride_id'];
    $age = $_POST['passenger_id'];
    $height = $_POST['passengerid'];
    $weight = $_POST['passengeid'];
